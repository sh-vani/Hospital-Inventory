                    ...
                    <div className="card-body">
                      <div className="row">
                        <div className="col-md-6">
                          <p><strong>Request ID:</strong> {selectedNotification.details.requestId}</p>
                          {(selectedNotification.type === 'approval' || selectedNotification.type === 'partial_approval') && (
                            <p><strong>Approved By:</strong> {selectedNotification.details.approvedBy}</p>
                          )}
                          {selectedNotification.type === 'rejection' && (
                            <p><strong>Rejected By:</strong> {selectedNotification.details.rejectedBy}</p>
                          )}
                          {(selectedNotification.type === 'approval' || selectedNotification.type === 'partial_approval') && (
                            <p><strong>Approved Date:</strong> {selectedNotification.details.approvedDate}</p>
                          )}
                          {selectedNotification.type === 'rejection' && (
                            <p><strong>Rejected Date:</strong> {selectedNotification.details.rejectedDate}</p>
                          )}
                        </div>
                        <div className="col-md-6">
                          {selectedNotification.details.pickupInfo && (
                            <>
                              <p><strong>Pickup Location:</strong> {selectedNotification.details.pickupInfo.location}</p>
                              <p><strong>Pickup Date:</strong> {selectedNotification.details.pickupInfo.date}</p>
                              <p><strong>Pickup Time:</strong> {selectedNotification.details.pickupInfo.time}</p>
                              {selectedNotification.details.pickupInfo.referenceNumber && (
                                <p><strong>Reference Number:</strong> {selectedNotification.details.pickupInfo.referenceNumber}</p>
                              )}
                            </>
                          )}
                        </div>
